...
public class GestioneTasseRepartoImpl {
	...
	public GestioneTasseRepartoImpl(final String name){
		this.repName=name;
	...
	public class GestioneTasseRepartoImplPane extends MyJPanelImpl{
		...
		public GestioneTasseRepartoImplPane(){
			...
			this.infoLeContainer.add(createJLabel("<html><U>Membri che non hanno pagato la tassa annuale</U></html>",FONTSIZE),
					BorderLayout.SOUTH); 
			((JLabel)this.infoLeContainer.getComponent(2)).setBorder(BorderFactory.createMatteBorder(1, 0, 0, 0, MyColor.BLACK.get()));
			((EditableMemberPanelImpl<Member>)this.center.getComponent(1)).
