...
public class GestioneTasseSquadrigliaImpl {
	...
	public class GestioneTasseSquadrigliaImplPane extends MyJPanelImpl {
		...
		public GestioneTasseSquadrigliaImplPane() {
			...
			panelIscrizione.add(new EditableMemberPanelImpl<Member>(Type.RETTASQUAD, MyOptional.of(squadName)),
					BorderLayout.CENTER);
			panelEscursioni.add(new EditableMemberPanelImpl<Member>(Type.TASSEEXCSQUAD, MyOptional.of(squadName)),
					BorderLayout.CENTER);
