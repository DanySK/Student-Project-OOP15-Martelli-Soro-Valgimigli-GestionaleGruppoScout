...
public class GemellaggiImpl extends ExcursionImpl implements Gemellaggi {
	...
	public GemellaggiImpl (final LocalDate dateStart,final LocalDate dateEnd,final Reparto reparto,final String name,final List<String>altriReparti) throws IllegalDateException{
	...
	public GemellaggiImpl (final LocalDate dateStart,final int durata,final Reparto reparto,final String name,final List<String>altriReparti) throws IllegalDateException{
		super (name,dateStart,reparto.getAllMember());
